...
\newcommand{\mapalt}[2]{\yrightarrow[#2][2.5pt][#1][-1pt]}
...
Current view of category theory : 
% it is a language designed to be able to give unified descriptions of 
% various phenomena which occur in different areas of mathematics.
a single language / point-of-view in which you can do most of mathematics. 
(No one can save the analysts.)
It is a nice tool for organization of results.
When approaching new content, 
I now constantly ask myself these three questions : 
\begin{itemize}
  \item Is this a universal property?
  \item Is this an adjunction?
  \item Is this just Yoneda?
\end{itemize}

In this document, we do not pay attention to foundational set-theoretic issues
like the ``set'' of all sets being be a proper class.  
